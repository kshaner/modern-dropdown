...
if(n){this.container="string"==typeof n?document.querySelector(n):n,this.opts={delay:250,openClass:"dropdown--open",menu:"> ul",spa:!1}
for(var c in o)o.hasOwnProperty(c)&&(this.opts[c]=o[c])
...
return"function"==typeof window.jQuery&&(window.jQuery.fn.dropdown=function(e){window.jQuery(this).each(function(){window.jQuery(this).data("dropdown",new o(this,e))})}),o}()
